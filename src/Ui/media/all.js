    ...
    Loading.prototype.showTrackerTorBridge = function (server_info) {
      ...
      if ($(".console .button-settrackerbridge").length === 0 && !server_info.tor_use_meek_bridges) {
        ...
        if (!server_info.tor_has_meek_bridges) {
          ...
          return this.printLine("No meek bridge support in your client, please <a href='https://github.com/HelloEpixNet/EpixNet#how-to-join'>download the latest bundle</a>.", "warning");
        }
      }
    };
...
(function () {
  ...
  ws_url = proto.ws + ":" + origin.replace(proto.http + ":", "") + "/EpixNet-Internal/Websocket?wrapper_key=" + window.wrapper_key;
  ...
  WrapperEpixFrame = (function () {
    ...
    WrapperEpixFrame.prototype.certSelectGotoSite = function (elem) {
      ...
      if (this.isProxyRequest()) {
        return $(elem).attr("href", "http://epix" + href);
      }
    };
